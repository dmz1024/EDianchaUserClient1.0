...
public class UpdateRetrofitUtil {
    public static final String BASE_URL = "http://api.fir.im/apps/latest/5819d4d4959d693e89001581/";
    private static UpdateRetrofitUtil retrofitUtil;
    ...
    private static class SingletonHolder {
        private static final UpdateRetrofitUtil INSTANCE = new UpdateRetrofitUtil();
    }

    //获取单例
    public static UpdateRetrofitUtil getInstance() {
        if (retrofitUtil == null) {
            return retrofitUtil = UpdateRetrofitUtil.SingletonHolder.INSTANCE;
        }
        return retrofitUtil;
    }
